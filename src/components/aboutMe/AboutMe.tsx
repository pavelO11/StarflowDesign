            ...
            <section className='textMain'>
                ...
                {isServicesPage ? (
                    <React.Fragment>
                        ...
                        <h4 >Разделяю большие и сложные задачи на самодостаточные и прозрачные этапы, чтобы клиент всегда знал, как движется его проект.</h4>
                    </React.Fragment>
                ) : (
                    <React.Fragment>
                        ...
                        <h3 >Я люблю продуманный дизайн. Стремлюсь к понятности, простоте и эстетике. <br/>Пробую современные визуальные решения. Каждая моя работа — это вызов самому себе.</h3>                  
                    </React.Fragment>
                )}      
            </section>
            {isServicesPage ? (
